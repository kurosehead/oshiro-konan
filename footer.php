<footer>
  <div class="footer--above">
    ...
    <div class="above-inner container">
      ...
      <div class="above-right">
        <div class="tab access-tab">
          <!-- ボタン -->
          <div class="tab__area access-tab__button-area">
            <div class="tab__button access-tab__button active">車でのご来院の方</div>
            <div class="tab__button access-tab__button">公共交通機関/<br class="sp">タクシー</div>
          </div>
          <div class="tab__panel-area access-tab__panel-area">
  ...
  <div class="footer--sitemap">
    <div class="sitemap__inner container">
      <div class="sitemap__block">
        <p class="sitemap__block-ttl">サイトマップ</p>
        <ul class="list-arrow">
          <li>
